...
def add_new_row(current_tree_bottom, total_tree, recursion_count = 0):
    
    if recursion_count > 50:
        raise NameError('TooManyRecursionError')         # prevent no use recursion by myt
    ...
    if total_options > 0:
        ...
        return add_new_row(current_tree_bottom, total_tree, recursion_count+1) # choose a new block and try again if no options available
